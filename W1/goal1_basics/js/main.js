...
if (weather === "sunny" && waves == 10 ){
    ...
    console.log("bob is mellow");
}else if(weather === "sunny" && waves > 9 && waves < 5){
    console.log("bobs mood is bummed");
}else if(weather === "overcast" && waves <= 10 && waves >= 7){
    console.log("bobs mood is jackedUp");
}else if(weather === "overcast" && waves <=6 && waves >= 3){
    console.log("bobs mood is totally Bummed")
}else{
    console.log("sad")
}
*/
...
var weather = 'Sunny';
var temp = 60;
var student1 = (weather === "sunny" && temp<80)? "happy" :"sad";
